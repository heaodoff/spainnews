...
Оцени новость:
5 — критично (законы, визы, аренда, налоги)
4 — очень важно (цены, жильё, работа)
3 — умеренно (быт, скидки, рынок)
2 — слабая
1 — мусор
---
## ШАГ 2 — РЕШЕНИЕ
...
Что это значит для жизни в Испании
• пункт
• пункт
• пункт

Как это повлияет
• цены / аренда / документы / работа
