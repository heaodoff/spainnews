...
Оцени новость:
5 — критично (законы, визы, аренда, налоги, стихийные бедствия, ЧП)
4 — очень важно (цены, жильё, работа, погодные аномалии, крупные события)
3 — умеренно (быт, скидки, рынок, культура, карнавалы, фестивали, транспорт)
2 — слабая (мелкие местные новости без значения для широкой аудитории)
1 — мусор (реклама, спам, не про Испанию)
---
## ШАГ 2 — РЕШЕНИЕ
1–2 → OUTPUT: SKIP
3 → SHORT
