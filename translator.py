...
2 — СЛАБО: корпоративные отчёты, абстрактная политика без влияния на быт, общие тренды без цифр, биржевые новости, спортивные события, повторы уже известных фактов
1 — МУСОР: реклама, не про Испанию, пресс-релизы компаний, мнения без фактов
